...
// FIXM: Add path annotation for gameusers 
@Path("/gameusers")
...
public class GameUserRESTController {
    ...
    public GameUserRESTController(Validator validator) {
    	System.out.println(">>> GameUserRESTController LOADED <<<");
    ...
    // FIXM: Add RolesAllowed annotation for USER based on BasicAuth Security Example 
    ...
    // FIXM: Add RolesAllowed annotation for ADMIN based on BasicAuth Security Example 
